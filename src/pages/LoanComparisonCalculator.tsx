...
function LoanComparisonCalculator() {
  ...
  const particularsSection = (
    <ParticularsSection
      title="How Loan Comparison is Calculated"
      items={[
        <><b>Loan Amount:</b> The principal amount borrowed for each loan.</>,
        <><b>Interest Rate:</b> The annual interest rate for each loan.</>,
        <><b>Tenure:</b> The number of years/months for repayment.</>,
        <><b>EMI:</b> Calculated for each loan using the standard EMI formula.</>,
        <><b>Total Interest:</b> Total interest paid over the loan tenure.</>,
        <><b>Total Payment:</b> Total amount repaid (principal + interest).</>,
      ]}
    />
  );
